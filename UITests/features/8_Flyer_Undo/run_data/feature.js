...
(function() {
  var CameraScreen, CropScreen, FlyerScreen, ForgotScreen, GalleryScreen, Helpers, HomeScreen, InviteScreen, RegisterScreen, SavedScreen, Screen, SettingsScreen, ShareSettingsScreen, SignInScreen, WelcomeScreen, Zucchini, app, extend, raise, rotateTo, screensCount, target, view, wait, waitForElement, _elementFrom,
  ...
  GalleryScreen = (function(_super) {
    ...
    GalleryScreen.prototype.anchor = function() {
      return $('navigationBar[name=GalleryView]');
    };
  ...
  HomeScreen = (function(_super) {
    ...
    HomeScreen.prototype.anchor = function() {
      return $('navigationBar[name=LauchView]');
    };
