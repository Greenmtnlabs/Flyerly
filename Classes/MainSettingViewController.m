...
//    }
    ...
    [category addObject:@"Evercam"];
    [category addObject:@"PhotoFixx"];
    [category addObject:@"GIFing"];
    [category addObject:@"Shuotes"];
    ...
    [category addObject:@"GreenMtnLabs on AppStore"];
    ...
    if ( [self isLogin] ) {
        ...
        if (indexPath.row == 10)
        {
         ...
         if (indexPath.row == 11)imgname = @"icon_untech";//untech
          ...
          if (indexPath.row == 13)imgname = @"icon_evercam";//evercam
          if (indexPath.row == 14)imgname = @"icon_photofixx";//photofixx
          if (indexPath.row == 15)imgname = @"icon_gifing";//gifing
          if (indexPath.row == 16)imgname = @"icon_shoutes";//shoutes
          ...
          if (indexPath.row == 18)imgname = @"icon_greenlabs";
        ...
        if (indexPath.row == 12)imgname = @"icon_evercam";//evercam
        if (indexPath.row == 13)imgname = @"icon_photofixx";//photofixx
        if (indexPath.row == 14)imgname = @"icon_gifing";//gifing
        if (indexPath.row == 15)imgname = @"icon_shoutes";//shoutes
        ...
        if (indexPath.row == 17)imgname = @"icon_greenlabs";
    }
...
- (void)tableView:(UITableView *)tView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ( [self isLogin]) {
        ...
        {
           [self openITunes:@"evercam-photo-edit-filters-share-w-friends/id1093877555?mt=8"]; //evercam
        }
        else if (indexPath.row == 14)
        {
           [self openITunes:@"photofixx-photos-ready/id903396250?mt=8"]; //photofixx
        }
        else if (indexPath.row == 15)
        {
           [self openITunes:@"gifing-ultimate-animated-gif-giphy-maker/id1135368392?mt=8"]; //gifing
        }
        else if (indexPath.row == 16)
        {
           [self openITunes:@"shuotes-add-quotes-to-photos-selfies-to-share/id1093460694?mt=8"]; //shoutes
        }
        ...
        {
           //[self openITunes:@"eyespot/id611525338?mt=8"];
        
            NSString *urlString = @"https://apps.apple.com/us/developer/green-mtn-labs-inc/id344130518";
