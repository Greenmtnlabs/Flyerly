...
- (BOOL) checkKeyExistsInPurchases : (NSString *)productId {
    ...
    {
        return YES;
    } else if ( [oldPurchases objectForKey: IN_APP_ID_ALL_DESIGN] || [oldPurchases objectForKey: IN_APP_OLD_ID_ALL_DESIGN] || [oldPurchases objectForKey: PRODUCT_ICON_SELETED]) {
        return YES;
    } else {
