...
-(void)shareOnInstagram{
    ...
    self.dicController.UTI = @"com.instagram.photo";//"com.instagram.photo";
...
-(IBAction)onClickTwitterButton
{
    ...
    {
        [self showAlert:@"Warning!" message:@"Please install Twitter app to share."];
    }
...
-(IBAction)onClickEmailButton{
    if ([self.flyer isVideoFlyer]) {
        ...
        if ([self.flyer isVideoFlyer]) {
            // Current Video Link For Sharing
            item = [SHKItem text: [NSString stringWithFormat:@"%@ Made by Flyerly",[self.flyer getYoutubeLink]]];
            ...
            bodyText = [NSString stringWithFormat:@"%@ Made by Flyerly",[self.flyer getYoutubeLink]];

        }else {
            item = [SHKItem image:selectedFlyerImage title:[NSString stringWithFormat:@"%@ for you!", flyerConfigurator.appName ]];
            item.text = @"Made by Flyerly";
            bodyText = @"Made by Flyerly";
        }
...
-(IBAction)onClickSMSButton{
    ...
    else if([MFMessageComposeViewController canSendAttachments])
    {
        ...
        messageComposer.messageComposeDelegate = self;
        if ([self.flyer isVideoFlyer]) {
            [messageComposer setBody:[NSString stringWithFormat:@"%@ Made by Flyerly",[self.flyer getYoutubeLink] ]];
        } else {
            [messageComposer setBody:@"Made by Flyerly"];
...
//    }
   ...
   // self.dicController.UTI = @"com.instagram.photo";//"com.instagram.photo";
    ...
    if(!displayed)
    {
        [self showAlert:@"Warning!" message:@"Please install Facebook Messanger app to share."];
        [messengerButton setSelected:NO];
    }else {
        // Update Flyer Share Info in Social File
        [self.flyer setMessengerStatus:1];
        [Flurry logEvent:@"Shared Facebook Messanger"];
    }
//    if([self.flyer isVideoFlyer]){
...
-(IBAction)onClickFacebookButton{
    ...
    {
        [self showAlert:@"Warning!" message:@"Please install Facebook app to share."];
    }
