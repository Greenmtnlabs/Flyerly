...
@synthesize shouldShowAdd,vwSegment;
...
- (void)viewDidAppear:(BOOL)animated
{
    if(IS_IPHONE_5)
    {
        vwSegment.translatesAutoresizingMaskIntoConstraints = true;
        segmentedButton.translatesAutoresizingMaskIntoConstraints = true;
        webView.translatesAutoresizingMaskIntoConstraints = true;
        
        vwSegment.frame = CGRectMake(vwSegment.frame.origin.x, vwSegment.frame.origin.y + 70, vwSegment.frame.size.width, vwSegment.frame.size.height);
        segmentedButton.frame = CGRectMake(segmentedButton.frame.origin.x, segmentedButton.frame.origin.y, segmentedButton.frame.size.width, segmentedButton.frame.size.height);
...
{
    double x = [UIScreen mainScreen].bounds.size.width - 80;//self.view.frame.size.width - 80;
    double y = [UIScreen mainScreen].bounds.size.height; //self.view.frame.size.height;
