...
//Outlets form zoom
@synthesize zoomScrollView,zoomScreenShot,zoomMagnifyingGlass,zoomScreenShotForVideo,dicController;
...
@synthesize flyimgView,currentLayer,layersDic,flyer,player,playerView,playerToolBar,playButton,playerSlider,tempelateView,avPlayer;
...
{
    if (isNewFlyer && (IS_IPHONE_4 ||  IS_IPHONE_6 || IS_IPHONE_6_PLUS || IS_IPHONE_XR || IS_IPHONE_XS) )
    {
            ...
            if( [[dic objectForKey:@"type"] isEqualToString:FLYER_LAYER_WATER_MARK] ){
                ...
                if ( [[dic objectForKey:@"flyerOpenTime"] isEqualToString:@"0"] )
                {
                    if( IS_IPHONE_4 || IS_IPHONE_5 )
                    {
                        ...
                        x = [NSString stringWithFormat:@"%f", (device_width - [dic[@"width"] doubleValue] - 29.25)];
                        y = [NSString stringWithFormat:@"%f", (device_width - [dic[@"height"] doubleValue] * 1.5)];
                    }
                    else if( IS_IPHONE_6)
                    {
                        device_width = 375;
                        ...
                        x = [NSString stringWithFormat:@"%f", (device_width - [dic[@"width"] doubleValue] - 29.25)];
                        y = [NSString stringWithFormat:@"%f", (device_width - [dic[@"height"] doubleValue] - 37.25)];
                    }
                    else if( IS_IPHONE_XS )
                    {
                        ...
                        x = [NSString stringWithFormat:@"%f", (device_width - [dic[@"width"] doubleValue] - 29.25)];
                        y = [NSString stringWithFormat:@"%f", (device_width - [dic[@"height"] doubleValue] + 50)];
                    }
                    else if( IS_IPHONE_6_PLUS)
                    {
                        ...
                        x = [NSString stringWithFormat:@"%f", (device_width - [dic[@"width"] doubleValue]  - 29.25)];
                        y = [NSString stringWithFormat:@"%f", (device_width - [dic[@"height"] doubleValue]  - 35.25)];
                    }
                    else if(IS_IPHONE_XR)
                    {
                        ...
                        x = [NSString stringWithFormat:@"%f", (device_width - [dic[@"width"] doubleValue]  - 29.25)];
                        y = [NSString stringWithFormat:@"%f", (device_width - [dic[@"height"] doubleValue]  + 60)];
                    }
...
-(void)viewDidAppear:(BOOL)animated {
    ...
    if( isNewFlyer )
    {
        create_flyer_default_image = @"Template75.jpg"; //create_flyer_default_image
...
//    [UserVoice initialize:config];
    ...
    dispatch_async( dispatch_get_main_queue(), ^{
        ...
        dispatch_async( dispatch_get_main_queue(), ^{
            ...
            if( IS_IPHONE_4 || IS_IPHONE_5 || IS_IPHONE_6 || IS_IPHONE_6_PLUS || IS_IPHONE_XS || IS_IPHONE_XR)
            {
                ...
                }else if ( IS_IPHONE_6 || IS_IPHONE_XS){
                ...
                }else if ( IS_IPHONE_6 || IS_IPHONE_XR || IS_IPHONE_XS ){
...
-(void)addTemplatesInSubView{
    ...
    dispatch_async( dispatch_get_main_queue(), ^{
        ...
        if(IS_IPHONE_5 || IS_IPHONE_6 || IS_IPHONE_6_PLUS || IS_IPHONE_XS || IS_IPHONE_XR)
        {
        ...
        for (UIView *sub in backgroundsView.subviews)
        {
            if ([sub isKindOfClass:[UIButton class]])
            {
                ...
                if(btn.tag == 75 && isNewFlyer)
                {
                    isNewFlyer = NO;
                    [self selectTemplate:btn];
                }
            }
        }
    });
...
-(void)addFlyerBorderInSubView {
    ...
    dispatch_async( dispatch_get_main_queue(), ^{
        ...
        if(IS_IPHONE_5 || IS_IPHONE_6 || IS_IPHONE_6_PLUS || IS_IPHONE_XS || IS_IPHONE_XR){
            ...
            if( IS_IPHONE_6_PLUS || IS_IPHONE_XS || IS_IPHONE_XR )
            {
        ...
        dispatch_async( dispatch_get_main_queue(), ^{
            ...
            for (int i = 1; i <=fontsArrayCount ; i++)
            {
                ...
                if( i != 0 )
                {
                    ...
                    else if(IS_IPHONE_XS && ( i%8 == 0 ) )
                    { //iphon6+ screen can show 8 font type icons
                        fOPrem[4] = 0; fOPrem[5] = 584;
                        curXLoc = 13;
                        curYLoc = curYLoc + heightValue + 6;
                    }
                    else if(IS_IPHONE_6_PLUS && ( i%9 == 0 ))
                    { //iphon6+ screen can show 8 font type icons
                        fOPrem[4] = 0; fOPrem[5] = 584;
                        curXLoc = 13;
                        curYLoc = curYLoc + heightValue + 6;
                    }
                    else if(IS_IPHONE_XR && ( i%9 == 0 ) )
                    { //iphon6+ screen can show 8 font type icons
                        fOPrem[4] = 0; fOPrem[5] = 584;
                        curXLoc = 13;
                        curYLoc = curYLoc + heightValue + 7;
...
-(void)addColorsInSubView{
    ...
    if( IS_IPHONE_5 ){
        ...
        curYLoc = 10;
        increment = 8;
    } else if( IS_IPHONE_6 || IS_IPHONE_6_PLUS || IS_IPHONE_XS || IS_IPHONE_XR){
        curXLoc = 13;
        curYLoc = 13;
        increment = 13;
    }
...
-(void)addSizeInSubView{
    ...
    dispatch_async( dispatch_get_main_queue(), ^{
        ...
        if(IS_IPHONE_5 || IS_IPHONE_6 || IS_IPHONE_6_PLUS || IS_IPHONE_XS || IS_IPHONE_XR)
        {
            ...
            {
                sizesView.frame = CGRectMake((layerScrollView.frame.origin.x + 17), (layerScrollView.frame.origin.y), sizesView.frame.size.width, sizesView.frame.size.height);
            }
...
-(void)addTextBorderInSubView{
    ...
    dispatch_async( dispatch_get_main_queue(), ^{
        ...
        } else if( IS_IPHONE_6_PLUS || IS_IPHONE_XS || IS_IPHONE_XR ){
...
-(void)addClipArtsInSubView{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_LOW, 0), ^{
        ...
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            else if ( IS_IPHONE_XR || IS_IPHONE_6_PLUS)
            {
        ...
        for( int i=1 ; i<=emoticonsArrayCount; i++ ) {
            ...
            [symbolArray addObject:symbolImg];
                ...
                else if(IS_IPHONE_6)
                {
                    ...
                    if(curXLoc >= 400){
                        curXLoc = initialX;
                        curYLoc = curYLoc + symbolScrollHeight + 6;
                    }
                }
                else if(IS_IPHONE_6_PLUS && i%6 == 0)
                {
                    fOPrem[4] = 0; fOPrem[5] = 550;
                    curXLoc +=  - 2;
                    //if(curXLoc >= 320){
                        curXLoc = initialX;
                        curYLoc = curYLoc + symbolScrollHeight + 8;
                    //}
                }
                else if (IS_IPHONE_XS && i%5 == 0 )
                {
                    fOPrem[4] = 0; fOPrem[5] = 584;
          ...
          if( IS_IPHONE_5 || IS_IPHONE_6 || IS_IPHONE_6_PLUS || IS_IPHONE_XS || IS_IPHONE_XR)
          {
            ...
            if (  [userPurchases checkKeyExistsInPurchases: IN_APP_ID_ICON_BUNDLE] == NO  ) {
                ...
                {
                    emoticonsView.size = CGSizeMake(370, curYLoc + symbolScrollHeight);
                    [layerScrollView setContentSize:CGSizeMake(320, curYLoc + symbolScrollHeight + bannerHeight)];
                }
                else if( IS_IPHONE_6_PLUS || IS_IPHONE_XR)
                {
...
-(void)addAllLayersIntoScrollView {
    ...
    for (NSString* uid in sortedLayers) {
        ...
        if ( ![uid isEqualToString:@"Template"] ) {
            ...
            if(IS_IPHONE_5 || IS_IPHONE_6_PLUS || IS_IPHONE_XS || IS_IPHONE_XR){
                if(curXLoc >= 300){
                    curXLoc = 10;
...
-(void)selectTemplate:(id)sender
{
    ...
    for(UIView *tempView  in [backgroundsView subviews])
    {
        ...
        if(tempView == view)
        {
            ...
            if (lstTag != view.tag || view.tag == 0 || view.tag ==  75)
            {
...
-(void)loadPlayerWithURL :(NSURL *)movieURL
{
    ...
    avPlayer = [AVPlayer playerWithURL:movieURL];
...
//                                                   object:nil];
    ...
    [self.playerView bringSubviewToFront:player.view];
...
//    [self.flyimgView addSubview:playerToolBar];
    ...
    [player setVideoGravity:AVLayerVideoGravityResizeAspect];
...
-(void)videoPlay:(BOOL)playOrStop repeat:(BOOL)repeat  changeAlph:(BOOL)changeAlph{
    ...
    if ( playOrStop )
    {
        if(player != nil )
        {
            ...
            isPlaying = YES;
            [player.player play];
            //player.player.repeatMode = repeat;
...
-(void)openPanel
{
    ...
    if ( [[PFUser currentUser] sessionToken] )
    {
        ...
        NSString* shareText = @"Made by Flyerly";
        NSURL *website = [NSURL URLWithString:@"http://greenmtnlabs.com/flyerly/index.html?i=FHgB9l98ab"];
        UIImage *shareImage =  [self getFlyerSnapShot];
       // NSURL *youtubeLink = [NSURL URLWithString:isAnyVideoUploadOnYoutube];
       __block NSArray *shareArray = @[];
        
        if ([flyer isVideoFlyer])
        {
            NSString *videoPath = [NSString stringWithFormat:@"%@",[self.flyer getSharingVideoPath]];
            __block NSURL *videoUrl =  [NSURL fileURLWithPath:videoPath];
            
            shareImage = [self.flyer getSharingVideoCover];
            
            NSURL *documentsURL = [[[NSFileManager defaultManager] URLsForDirectory:NSDocumentDirectory inDomains:NSUserDomainMask] firstObject];
            NSURL *tempURL = [documentsURL URLByAppendingPathComponent:[videoUrl lastPathComponent]];
            videoUrl = tempURL;
            
            shareArray = @[shareText, website,videoUrl];
            
//            NSURLSessionTask *download = [[NSURLSession sharedSession] downloadTaskWithURL:videoUrl completionHandler:^(NSURL *location, NSURLResponse *response, NSError *error) {
//                if(error) {
//                    NSLog(@"error saving: %@", error.localizedDescription);
//                    return;
//                }
...
//            [download resume];
        ...
        {
            shareArray = @[shareText, website,shareImage];
        }
...
//        UIGraphicsEndImageContext();
//        UIImage *shareImage =  [self getFlyerSnapShot];
//        UIImage *originalImage = shareImage;//[UIImage imageWithContentsOfFile:imageFileName];
//        NSString *imageFileName = [flyer getFlyerImage];
//        NSString  *updatedImagePath = [imageFileName stringByReplacingOccurrencesOfString:[NSString stringWithFormat:@".%@",IMAGETYPE ] withString:@".ig"];
...
//       
//        [self.dicController presentOpenInMenuFromRect:rect inView: self.view animated:YES];
