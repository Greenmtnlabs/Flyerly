...
-(void)setOrSaveVars:(NSString *)setOrSAve
{
    ...
    if( [setOrSAve isEqualToString:SAVE] ) {
        ...
        endDate         = ( dic[@"endDate"] ) ? dic[@"endDate"] : [commonFunctions nsDateToTimeStampStr: [[NSDate date] dateByAddingTimeInterval:(60*60*120)] ]; //current time +2hr
...
-(void)initWithDefValues
{
    ...
    endDate   = [commonFunctions nsDateToTimeStampStr: [[NSDate date] dateByAddingTimeInterval:(60*60*24)] ]; //current time +2hr
    hasEndDate = YES;
