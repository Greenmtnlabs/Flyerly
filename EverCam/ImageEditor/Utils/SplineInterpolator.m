...
@interface SplineCalculator : NSObject
...
@implementation SplineInterpolator
{
    NSInteger _pointNum;
    
    SplineCalculator *_splineX;
    SplineCalculator *_splineY;
}
...
- (id)initWithPoints:(NSArray *)points
{
    ...
    if(self){
        ...
        _splineX = [[SplineCalculator alloc] initWithData:dataX dataNum:_pointNum];
        _splineY = [[SplineCalculator alloc] initWithData:dataY dataNum:_pointNum];
...
@implementation SplineCalculator
{
    NSInteger _dataNum;
    double *a, *b, *c, *d;
}
