...
- (NSDictionary*)descriptionDictionary
{
    ...
    for(ImageToolInfo *sub in self.sortedSubtools){
...
- (NSString*)toolName
{
    if([_toolName isEqualToString:@"ImageEditorViewController"]){
        return @"ImageEditor";
    }
    return _toolName;
}
...
{
    ImageToolInfo *result = nil;
    
    for(ImageToolInfo *sub in self.subtools){
