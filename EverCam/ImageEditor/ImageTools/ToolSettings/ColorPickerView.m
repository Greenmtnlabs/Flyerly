...
@protocol HueCircleViewDelegate;

@interface _HueCircleView : UIView
@property (nonatomic, weak) id <HueCircleViewDelegate> delegate;
- (CGFloat)hue;
- (CGFloat)brightness;
- (UIColor*)color;
...
@protocol HueCircleViewDelegate <NSObject>
@optional
- (void)hueCircleViewDidChange:(_HueCircleView *)view;
...
<HueCircleViewDelegate>
@end

@implementation ColorPickerView
{
    _HueCircleView *_hueCircle;
...
- (void)customInit
{
    ...
    _hueCircle = [[_HueCircleView alloc] initWithFrame:CGRectMake(0, 0, W, W)];
    _hueCircle.delegate = self;
    [self addSubview:_hueCircle];
    
    
    // Saturation Slider for Text FillColor ====================
    ...
    [_saturationSlider setThumbImage:[UIImage imageNamed:@"saturationThumb"] forState:UIControlStateNormal];
    [_saturationSlider setThumbImage:[UIImage imageNamed:@"saturationThumb"] forState:UIControlStateHighlighted];

    [self addSubview:_saturationSlider];
    

    // Alpha Slider, for Text's opacity ===================
    ...
    [_alphaSlider setThumbImage:[UIImage imageNamed:@"alphaThumb"] forState:UIControlStateNormal];
    [_alphaSlider setThumbImage:[UIImage imageNamed:@"alphaThumb"] forState:UIControlStateHighlighted];
