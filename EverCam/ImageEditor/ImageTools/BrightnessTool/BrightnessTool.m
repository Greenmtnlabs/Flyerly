...
+ (NSString*)defaultTitle {
    ...
    return NSLocalizedString(@"BrightnessTool", @"");
}
...
- (void)setupSlider
{
    ...
    [_brightnessSlider setThumbTintColor:[UIColor blackColor]];
     
    [_brightnessSlider setMinimumTrackImage:[UIImage imageNamed:@"trackMin"] forState:UIControlStateNormal];
    [_brightnessSlider setMaximumTrackImage:[UIImage imageNamed:@"trackMax"] forState:UIControlStateNormal];
}
