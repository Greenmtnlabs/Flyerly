...
+ (NSString*)defaultTitle {
    return NSLocalizedString(@"ContrastTool", @"");
}
...
- (void)setupSlider {
    ...
    _contrastSlider.thumbTintColor = [UIColor blackColor];
    _contrastSlider.minimumTrackTintColor = LIGHT_COLOR;
    _contrastSlider.maximumTrackTintColor = LIGHT_COLOR;
}
