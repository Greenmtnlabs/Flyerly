...
// FONTS ===============================
#define MAIN_FONT [UIFont fontWithName:@"Titillium-Thin" size:10]
#define NAVBAR_FONT [UIFont fontWithName:@"Titillium-Semibold" size:16]
//-----------------------------------------------------------------------------


// YOUR INSTAGRAM USERNAME =====================================
#define INSTAGRAM_USERNAME @"evercamapp"
//-----------------------------------------------------------------------------


// YOUR INSTAGRAM PAGE URL =====================================
#define FACEBOOK_PAGE_LINK @"http://facebook.com/GreenMtnLabs"
//-----------------------------------------------------------------------------


// SHARING MESSAGE FOR TWITTER, FACEBOOK AND MAIL ===================
#define SHARING_TITLE @"Hi there!"
#define SHARING_MESSAGE @"Check out my picture, I've made it with #EverCam!"
...
#define IAP_PRODUCT @"com.evercam.premium"
//-----------------------------------------------------------------------------
