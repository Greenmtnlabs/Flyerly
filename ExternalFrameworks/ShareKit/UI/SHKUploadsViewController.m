    ...
    if (self) {
        ...
        _sendProgressObserver = [center addObserverForName:SHKUploadProgressNotification
                                                ...
                                                usingBlock:^(NSNotification *note) {
                                                    ...
                                                    NSUInteger index = [self.uploadInfoDataSource indexOfObject:uploadInfo];
                                                    NSIndexPath *indexPath = [NSIndexPath indexPathForRow:index inSection:0];
                                                    SHKUploadsViewCell *cell = (SHKUploadsViewCell *)[self.tableView cellForRowAtIndexPath:indexPath];
